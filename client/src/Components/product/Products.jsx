    ...
    <div>
      ...
      <div className='card-product-parent'>
        <div class="card-product">
          <div class="card-img-product"><img src="https://www.villain.in/cdn/shop/products/Villaindesire_perfume_02_360x.jpg?v=1649851901" alt="" srcset="" /></div>
          <div class="card-info-product">
            <p class="text-title-product">Product title </p>
            <p class="text-body-product">Product description and details</p>
          </div>
          <div class="card-footer-product">
            <span class="text-title-product">$499.49</span>
            <div class="card-button-product">
              <svg class="svg-icon-product" viewBox="0 0 20 20">
        ...
        <div class="card-product">
          <div class="card-img-product"><img src="https://splashfragrance.in/wp-content/uploads/2024/02/annick-Goutal-Bois-Dhadrien-Edp-7ml-Miniature-300x300.jpg" alt="" srcset="" /></div>
          <div class="card-info-product">
            <p class="text-title-product">Product title </p>
            <p class="text-body-product">Product description and details</p>
          </div>
        ...
        <div class="card-product">
          <div class="card-img-product"><img src="https://splashfragrance.in/wp-content/uploads/2018/09/bvlgari-500x500-product_thumb-300x300.jpg" alt="" srcset="" /></div>
          <div class="card-info-product">
            <p class="text-title-product">Product title </p>
            <p class="text-body-product">Product description and details</p>
          </div>
        ...
        <div class="card-product">
          <div class="card-img-product"><img src="https://splashfragrance.in/wp-content/uploads/2024/02/tom-ford-ebene-fume-300x300.jpg" alt="" srcset="" /></div>
          <div class="card-info-product">
            <p class="text-title-product">Product title </p>
            <p class="text-body-product">Product description and details</p>
          </div>
